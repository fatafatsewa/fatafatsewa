...
class Product extends Model
{
  ...
  public static function getallproducts($request)
  {
      ...
      $minPrice = $request->price['minPrice'] ?? null;
      $maxPrice = $request->price['maxPrice'] ?? null;
      $consumer_data = array();
      $consumer_data['consumer_key'] = request()->header('consumer-key');
      $consumer_data['consumer_secret'] = request()->header('consumer-secret');
      $consumer_data['consumer_nonce'] = request()->header('consumer-nonce');
  ...
  public static function getquantity($request)
  {
      ...
      //check products type
      if (isset($productsType[0]) && $productsType[0]->products_type == 1) {

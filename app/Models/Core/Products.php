...
class Products extends Model
{
  ...
  public function insert($request){
    ...
    $products_id = DB::table('products')->insertGetId([
        ...
        'is_current'         => 1,
        'emi_enabled' => $request->emi_enabled,
        'warrenty' => $request->warrenty,
        'available_offers' => $request->available_offers,
        'highlight_specifications' => $request->highlight_specifications
    ]);
  ...
  public function insertProductImages($request){
    $product_id = $request->products_id;
         ...
         DB::table('products_images')->insert([
             ...
             'color_id' => (isset($request->color)) ? $request->color : null
         ]);

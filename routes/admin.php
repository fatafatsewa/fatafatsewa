...
Route::group(['middleware' => ['installer']], function () {
    ...
    Route::group(['namespace' => 'AdminControllers', 'middleware' => 'auth', 'prefix' => 'admin'], function () {
        ...
        Route::post('/deleteSlider/', 'AdminSlidersController@deleteSlider')->middleware('website_routes');
          ...
          //homecategory
        Route::get('/homecategory', 'AdminHomecategoryController@all')->middleware('website_routes');
        Route::get('/addhomecategory', 'AdminHomecategoryController@addhomecategory')->middleware('website_routes');
          Route::post('/addNewhomecategory', 'AdminHomecategoryController@addNewhomecategory')->middleware('website_routes');
        Route::get('/edithomecategory/{id}', 'AdminHomecategoryController@edithomecategory')->middleware('website_routes');
        Route::post('/updateHomecategory', 'AdminHomecategoryController@updateHomecategory')->middleware('website_routes');
        Route::post('/deleteHomecategory/', 'AdminHomecategoryController@deleteHomecategory')->middleware('website_routes');
    ...
    Route::group(['prefix' => 'admin/categories', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        ...
        //CUSTOM DASHBOARD
        Route::get('/{id}/build-dashboard', 'CategoriesController@getBuildDashboard');
        Route::post('/{id}/build-dashboard/add-banner', 'CategoriesController@addCategoryBanner');
        Route::get('/{id}/build-dashboard/banner/{banner_id}/delete', 'CategoriesController@deleteCategoryBanner')->name('admin.category-banner.delete');
        Route::post('/{id}/build-dashboard/add-category', 'CategoriesController@addDashboardCategory');
        Route::get('/{id}/build-dashboard/{cat_id}/remove-category', 'CategoriesController@removeDashboardCategory');
...
//customers
    Route::group(['prefix' => 'admin/customers', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        ...
        Route::get('/{id}/detail', 'CustomersController@viewDetail')->middleware('view_customer');
    ...
    Route::group(['prefix' => 'admin/banks', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function() {
        Route::get('/display', 'BanksController@index');
        Route::get('/add', 'BanksController@add');
        Route::post('/insert', 'BanksController@insert');
        Route::get('/edit/{id}', 'BanksController@edit');
        Route::post('/update/{id}', 'BanksController@update');
    });

    Route::group(['prefix' => 'admin/exchange-requests', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function() {
        Route::get('/display', 'ExchangeController@index');
        Route::get('/{request_id}/view', 'ExchangeController@viewRequestDetail');

    });
    //repair
    Route::group(['prefix' => 'admin/repair-requests', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function() {
        Route::get('/display', 'RepairController@index');
        Route::get('/{request_id}/view', 'RepairController@viewRequestDetail');

    });

    Route::group(['prefix' => 'admin/emi', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function() {
        Route::get('/display', 'EmiController@index');
        Route::get('/{emi_id}/view', 'EmiController@viewDetail');
    ...
    Route::group(['prefix' => 'admin/orders', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        ...
        Route::post('/update-serial', 'OrdersController@updateProductSerial')->middleware('edit_order');
    });

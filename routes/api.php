...
Route::group(['namespace' => 'App', 'middleware'=> ['api']], function () {
	...
	*/
	...
	//get categories
	Route::post('/allcategories', 'MyProductController@allcategories')->middleware('cors');

	//getAllProducts
	Route::post('/getallproducts', 'MyProductController@getallproducts')->middleware('cors');

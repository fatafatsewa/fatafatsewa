<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php } ?>
      <li
      class="treeview {{ Request::is('admin/exchange-requests/display') ? 'active' : '' }} ">
      <a href="{{ URL::to('admin/exchange-requests/display') }}">
        <i class="fa fa-refresh" aria-hidden="true"></i> <span> Exchange Requests </span>
      </a>
    </li>
    
    <li
    class="treeview {{ Request::is('admin/repair-requests/display') ? 'active' : '' }} ">
    <a href="{{ URL::to('admin/repair-requests/display') }}">
      <i class="fa fa-refresh" aria-hidden="true"></i> <span> Repair Requests </span>
    </a>
  </li>

    <li
      class="treeview {{ Request::is('admin/emi/display') ? 'active' : '' }} ">
      <a href="{{ URL::to('admin/emi/display') }}">
        <i class="fa fa-refresh" aria-hidden="true"></i> <span> EMI Requests </span>
      </a>
    </li>
  ...
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
      ...
      <li
      class="treeview {{ Request::is('admin/banks/display') ? 'active' : '' }} {{ Request::is('admin/languages/add') ? 'active' : '' }} {{ Request::is('admin/languages/edit/*') ? 'active' : '' }} ">
      <a href="{{ URL::to('admin/banks/display') }}">
        <i class="fa fa-language" aria-hidden="true"></i> <span> Banks </span>
      </a>
    </li>
            ...
            <li class="treeview {{ Request::is('admin/topoffer/display') ? 'active' : '' }} {{ Request::is('admin/webPagesSettings/*') ? 'active' : '' }}">
              ...
              <ul class="treeview-menu">
                <li class="treeview {{ Request::is('admin/topoffer/display') ? 'active' : '' }} ">
                 ...
                 <li class="treeview {{ Request::is('admin/homecategory') ? 'active' : '' }} ">
                    <a href="{{url('admin/homecategory')}}">
                        <i class="fa fa-circle-o" aria-hidden="true"></i> <span> Home Page Category </span>
                    </a>
                </li>

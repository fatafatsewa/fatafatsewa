                                            ...
                                            @foreach ($categories as $key=>$category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-success" style="margin-bottom: 5px;" href="{{url('admin/categories/'. $category->id.'/build-dashboard') }}">Build Dashboard</a>
                                                            <br>
                                                            @endif
                                                            <a class="btn btn-primary" style="margin-bottom: 5px;" href="{{url('admin/categories/edit/'. $category->id) }}">Edit Category</a>
                                                        </br>
                                                        ...
                                                        {{-- <a class="btn btn-warning" style="width: 100%;  margin-bottom: 5px;" href="{{url('admin/products/images/display/'. $product->products_id) }}">{{ trans('labels.ProductImages') }}</a>
                                                            ...
                                                            @if($category->id >0 )<a id="delete" category_id="{{$category->id}}" href="#" class="btn btn-warning" >Delete Category</a>@endif
                                                        </td>
                                                    </tr>

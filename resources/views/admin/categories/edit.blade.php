                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                              <input type="text" name="meta_title" class="form-control" value="{{ $result['editSubCategory'][0]->meta_title }}">
                                            </div>
                                          </div>

                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Meta Desscription </label>
                                            <div class="col-sm-10 col-md-4">
                                              <input type="text" name="meta_description" class="form-control" value="{{ $result['editSubCategory'][0]->meta_description }}">
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                              <input type="text" name="meta_keywords" class="form-control" value="{{ $result['editSubCategory'][0]->meta_keywords }}">
                                            </div>
                                          </div>


                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Custom Dashboard</label>
                                            <div class="col-sm-10 col-md-4">
                                              <select class="form-control" name="custom_dashboard">
                                                    <option value="1" @if($result['editSubCategory'][0]->custom_dashboard=='1') selected @endif>Enable</option>
                                                    <option value="0" @if($result['editSubCategory'][0]->custom_dashboard=='0') selected @endif>Disable</option>
                                              </select>

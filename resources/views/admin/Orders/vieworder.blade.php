        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
                ...
                <td> 
                  <form action="/admin/orders/update-serial" method="post"> 
                    {!! csrf_field() !!}
                    <input type="hidden" name="orders_products_id" value="{{ $products->orders_products_id }}">
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Serial Number" name="serial_number" value="{{ $products->serial_number }}">
        ...
        <div class="col-xs-5">
          ...
          <div class="table-responsive ">
            <table class="table order-table">
              ...
              @if($data['orders_data'][0]->used_points)
              <tr>
                <th>Used Points:</th>
                <td>
                  {{ $data['orders_data'][0]->used_points }}
                  </td>
              </tr>
              @endif
            </table>

              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="modal-content">
                    ...
                    {!! Form::open(['url' => 'admin/products/images/insertproductimage', 'name' => 'addImageFrom', 'id' =>
                    'addImageFrom', 'method' => 'post', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data'])
                    !!}
                    {!! Form::hidden('products_id', $result['data']['products_id'], ['class' => 'form-control', 'id' =>
                    'products_id']) !!}

                    {!! Form::hidden('sort_order', count($result['products_images']) + 1, ['class' => 'form-control', 'id'
                    => 'sort_order']) !!}
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group" id="imageIcone">
                        ...
                        <div class="col-sm-10 col-md-4">
                          <!-- Modal -->
                          <div class="modal fade embed-images" id="ModalmanufacturedICone" tabindex="-1" role="dialog"
                                    ...
                                    <select class="image-picker show-html " name="image_id" id="select_img">
                                      ...
                                      @foreach ($allimage as $key => $image)
                                        <option data-img-src="{{ asset($image->path) }}" class="imagedetail"
                                          data-img-alt="{{ $key }}" value="{{ $image->id }}"> {{ $image->id }} </option>
                                      @endforeach
                                    </select>
                                  @endif
                                </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10 col-md-8">
                          <div class="col-md-6 col-sm-6">
                            {!! Form::textarea('htmlcontent', '', ['class' => 'form-control', 'id' => 'htmlcontent',
                            'colspan' => '3']) !!}
                      ...
                      <div class="alert alert-danger addError" style="display: none; margin-bottom: 0;" role="alert"><i
                          class="icon fa fa-ban"></i> {{ trans('labels.ChooseImageText') }} </div>

                      @if (isset($result['colors']))
                        <div class="form-group">
                          <label for="name" class="col-sm-2 col-md-4 control-label">Color</label>
                          <div class="col-sm-10 col-md-8">
                            <div class="col-md-6 col-sm-6">
                              <select name="color" id="" class="form-control">
                                  <option value=""></option>
                                @foreach ($result['colors'] as $color)
                                  <option value="{{ $color['products_attributes_id'] }}">{{ $color['value'] }}</option>
                                @endforeach
                              </select>
                            </div>
                          </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-8 float-right">
                        <a type="button" class="btn btn-default float-right"
                          href="{{ url('admin/products/images/display') }}/{{ $products_id }}">{{ trans('labels.back') }}
                        </a>

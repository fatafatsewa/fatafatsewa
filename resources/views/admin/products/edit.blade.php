                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label">EMI Enabled?</label>
                                                <div class="col-sm-10 col-md-8">
                                                    <select class="form-control" name="emi_enabled">
                                                        <option value="0" @if($result['product'][0]->emi_enabled == 0)
                                                            selected
                                                            @endif>{{ trans('labels.No') }}</option>
                                                        <option value="1" @if($result['product'][0]->emi_enabled == 1)
                                                            selected
                                                            @endif>{{ trans('labels.Yes') }}</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 control-label">Warrenty</label>
                                                    <div class="col-sm-10">
                                                        <textarea id="rich-editor" name="warrenty" class="form-control" rows="5">{{ $result['product'][0]->warrenty }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tabbable tabs-left">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane @if($j==0) active @endif" id="product_<?=$description_data['languages_id']?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label">Available Offeres</label>
                                                                <div class="col-sm-10 col-md-8">
                                                                    <textarea id="offers-editor" name="available_offers" class="form-control" rows="5">{{ $result['product'][0]->available_offers }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label">Highlight Specifications</label>
                                                                <div class="col-sm-10 col-md-8">
                                                                    <input type="text" class="form-control" placeholder="8 Gb RAM|128 Gb ROM" name="highlight_specifications" value='{{$result['product'][0]->highlight_specifications}}'>
                                                                    <span class="help-block">Seperate each specification by |</span>
...
<script type="text/javascript">
    $(function() {
        ...
        CKEDITOR.replace('offers-editor');

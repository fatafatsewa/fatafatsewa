            ...
            <div class="container">
             ...
             <form enctype="multipart/form-data" name="filters" id="test" method="get">
               ...
               @include('web.common.scripts.slider')
                     ...
                     @if(strtolower($attr_data['option']['name']) !== 'color')
                     <div class="color-range-main d-none d-sm-block">
                                     ...
                                     <li >
                                         <div class="form-check"  style="margin-bottom:6px">
                                           <label class="form-check-label">
                                             ...
                                             ?>>
                                             <span style="margin-left: 10px; font-size:16px">{{$values['value']}}</span>
                                           </label>
                                         </div>
                                     </li>
                                     @endforeach
                     ...
                     @endforeach
                     @endif
                     <div class="color-range-main mb-3">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12 col-lg-6">
                                          <div style="display: flex; align-items:center">
                                              <label style="font-weight: 700; margin: 10px">@lang('website.Display')</label>
                                              <div class="buttons">

    ...
    <script>
        function myFunction() {
        var x = document.getElementById("category-toogle");
 ...
 <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/jquery/jquery.min.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/owl-carousel/owl.carousel.min.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/nouislider/nouislider.min.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/photoswipe/photoswipe.min.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/photoswipe/photoswipe-ui-default.min.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/select2/js/select2.min.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/js/number.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/js/main.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/js/header.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/svg4everybody/svg4everybody.min.js"></script>
    <script>
        svg4everybody();
    </script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/minishop/mscompare.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/minishop/mswishlist.js"></script>
    <script src="{{asset('web')}}/custom/assets/themes/fatafatsewa/vendor/minishop/mscatalogfilter.js"></script>
    <script type="text/javascript" src="http://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5e968fabd38aa12a"></script>
<script type="text/javascript" src="assets/components/minishop2/js/web/defaulta827.js?v=d62e73368c"></script>
...
window.onload = function() {
    document.getElementById('my_depart').onclick = function() {

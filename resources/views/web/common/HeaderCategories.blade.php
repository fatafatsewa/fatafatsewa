 ...
 function productCategories(){
  ...
  $option = '';
    ...
    foreach($categories as $parents){
      ...
      $option .= '<li id="my_depart" class="departments__item"><a class="departments__item-link dropdown-item categories-list '.$selected.'" value="'.$parents->categories_name.'" slug="'.$parents->slug.'" '.$selected.'>'.$parents->categories_name.'</a></li>';

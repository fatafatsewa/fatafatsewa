            ...
            <table class="table top-table">
              ...
              <tbody  @if(session::get('out_of_stock') == 1 and session::get('out_of_stock_product') == $products->products_id)style="	box-shadow: 0 20px 50px rgba(0,0,0,.5); border:2px solid #FF9999;"@endif>
                  ...
                  <tr class="d-flex">
                   ...
                   ?>
                  <td class="item-price col-12 col-md-2 currencyField">
                    @if(!empty($products->final_price))
                    ...
                    <td class="align-middle item-total col-12 col-md-2" align="center">
                      <span class="cart_price_{{$products->customers_basket_id}} currencyField">
            ...
            <table class="table right-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td align="right" class="currencyField">
                    @php
                ...
                <tr class="item-price">
                  ...
                  <td align="right" class="currencyField">{{Session::get('symbol_left')}} {{session('currency_value') * $price+0-number_format((float)$coupon_amount, 2, '.', '')}}{{Session::get('symbol_right')}}</td>
                </tr>
              </tbody>
            </table>

  ...
  <div class="container">
    <div class="row">
          ...
          <div class="row">
            <div class="checkout-module">
              <ul class="nav nav-pills mb-3 checkoutd-nav d-none d-lg-flex" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link @if(session('step')==2) active @elseif(session('step')>2)  @endif" @if(session('step')>=2) id="pills-method-tab" data-toggle="pill" href="#pills-method" role="tab" aria-controls="pills-method" aria-selected="false" @endif> Shipping</a>
                  </li> --}}
                  <li class="nav-item">
                    ...
                    <form name="signup" enctype="multipart/form-data" class="form-validate"  action="{{ URL::to('/checkout_shipping_address')}}" method="post">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group d-none">
                          <input type="text" class="form-control" id="company" aria-describedby="companyHelp" placeholder="Enter Your Company Name" name="company" value="   ">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="address" class="city--custom-field form-control d-none" disabled>
                        ...
                        <div class="row" style="width: 100% !important; margin-bottom:15px">
                          <div class="col-sm-12">
                          <label for="">Nearest Place</label>
                          <input required type="text" class="form-control" name="street" placeholder="Nearest Popular Place">
                        </div>
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <input type="hidden" name="countries_id" value="149">
                        ...
                        {{-- <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input required type="number"   oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxlength="10" class="form-control" id="delivery_phone" aria-describedby="numberHelp" placeholder="@lang('website.Enter Your Phone Number')" name="delivery_phone" value="@if(!empty(session('shipping_address'))){{session('shipping_address')->delivery_phone}}@endif">
                                        ...
                                        <table class="table top-table">
                                              ...
                                              <tr class="d-flex">
                                                ...
                                                <td class="col-12 col-md-5 justify-content-start">
                                                  ...
                                                  <?php                                                      
                                                      $orignal_price = $products->final_price * session('currency_value');
                                                  ?>
                                                <td class="item-price col-12 col-md-2 currencyField"><span>{{Session::get('symbol_left')}} {{$orignal_price+0}}{{Session::get('symbol_right')}}</span></td>
                                                ...
                                                <td class="align-middle item-total col-12 col-md-2 justify-content-end currencyField">{{Session::get('symbol_left')}} {{$orignal_price+0}}{{Session::get('symbol_right')}}</td>
                                              </tr>
                                            ...
                                            @endforeach
                                                    ...
                                                    <?php
                                                        ...
                                                        if(session('use_reward_points')){
                                                          $reward_points = auth('customer')->user()->reward_points;
                                                          $usable_points = ($reward_points > 1000) ? 1000 : $reward_points;
                                                          if($usable_points > $total_price) {
                                                            $usable_points = $total_price;
                                                          }
                                                          session()->put('usable_points', $usable_points);
                                                          $total_price = $total_price - $usable_points;
                                                        }
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="form-group" style="width:100%; padding:0;">
                                            ...
                                            @foreach($result['payment_methods'] as $payment_methods)
                                              ...
                                              @if($payment_methods['payment_method'] === 'cash_on_delivery' || $total_price > 50)
                                            ...
                                            <br>
                                            {{-- <div.r>
                                              <img src="/web/images/spinner.gif" alt="" width="70px">
                                            </div.r>                        --}}
                                          </div>
                                          </form>
                                            ...
                                            <div class="button">
                                              ...
                                              @endforeach
                                                  ...
                                                  <div id="esewa_payment_section" style="display: none">
                                                    <form action="{{ url('/process-esewa') }}" method="POST">
                                                      {!! csrf_field() !!}
                                                  ...
                                                  <div id="app" class="cellpay_payment_section" style="display: none">
                                                    <div id="cellpay-payment-button"></div>

                                                    <form action="https://app.cellpay.com.np/test_merchant_api/" method="POST">
                                                      <input value="{{ $result['payment_methods'][12]['merchant_code'] }} " name="merchant_id" type="hidden">
                                                      <input value="{{number_format((float)$total_price+0, 2, '.', '')}}" name="amount" type="hidden">
                                                      <input value="{{ Carbon\Carbon::now()->timestamp.'-U-'.auth('customer')->user()->id }}" name="invoice_number" type="hidden">
                                                      <input value="CellPay_payment" name="description" type="hidden">
                                                      <input value="{{ route('process-cellpay', ['status'=>'success']) }}" type="hidden"
                                                      name="success_callback">
                                                      <input value="{{ route('process-cellpay') }}" type="hidden"
                                                      name="failure_callback">
                                                      <input value="{{ route('process-cellpay', ['status'=>'cancel']) }}" type="hidden"
                                                      name="cancel_callback">
                                                      <button type="submit" class="btn btn-secondary">Pay with CellPay</button>
                                                      </form>
                                                  </div>
                                                </div>
                                              </div>
      ...
      <div class="col-12 col-xl-3 checkout-right cart-page-one cart-area">
        <table class="table right-table">
          ...
          <tbody>
            <tr>
              ...
              <td align="right" class="currencyField">{{Session::get('symbol_left')}} {{$price+0}}{{Session::get('symbol_right')}}</td>
            ...
            <tr>
              ...
              <tr>
                ...
                <td align="right">{{ $usable_points }}</td>
                @endif
            <tr class="item-price">
              <th scope="row">@lang('website.Total')</th>
              <td align="right" class="currencyField" >{{Session::get('symbol_left')}} {{number_format((float)$total_price+0, 2, '.', '')+0*session('currency_value')}}{{Session::get('symbol_right')}}</td>
        ...
        <form action="/checkout/use-points" method="POST">
          @csrf
          
          @if(!session('use_reward_points'))
          <input type="hidden" name="total_price" value="{{ $total_price }}">
 
            <p><strong>Your reward points:</strong> {{ auth('customer')->user()->reward_points }}</p>
           <p><button class="btn btn-secondary" type="submit" @if(!$result['can_use_points']) disabled @endif>Use Points</button></p>
           @if(!$result['can_use_points'])
            Reward points cannot be used on beverage items.
           @endif
          @else 
            <p><strong>Remaining Points:</strong> {{ auth('customer')->user()->reward_points - $usable_points }}</p>
            <p><button class="btn btn-secondary" disabled type="submit">Using Points</button></p>
          @endif
        </form>
        </div>
    </div>
  ...
  jQuery(document).on('change', '.city--selector', function() {
    ...
    if(city) {
      if(city === 'Others') {
        ...
        $('.address--selector').prop('disabled', true)

        $('.city--custom-field').removeClass('d-none')
        $('.city--custom-field').prop('disabled', false)

      }else {
        $('.address--selector').show()
        $('.address--selector').prop('disabled', false)
        $('.city--custom-field').addClass('d-none')
        $('.city--custom-field').prop('disabled', true)

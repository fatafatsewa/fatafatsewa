        ...
        <table class="table items">
          ...
          <tbody>
            ...
            <tr class="d-flex responsive-lay">
              ...
              <td class="tag-color col-12 col-md-3 currencyField">{{Session::get('symbol_left')}}{{$products->final_price/$products->products_quantity*session('currency_value')}}{{Session::get('symbol_right')}}</td>
              <td class="col-12 col-md-2">
              ...
              <td  class="tag-s col-12 col-md-2 currencyField">{{Session::get('symbol_left')}}{{$products->final_price*session('currency_value')}}{{Session::get('symbol_right')}}</td>
            </tr>
            @endforeach
        @endif

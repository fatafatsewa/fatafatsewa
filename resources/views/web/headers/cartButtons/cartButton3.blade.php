<?php $qunatity=0; ?>
                ...
                <a href="#" id="dropdownCartButton_3" class="btn btn-light dropdown-toggle cart-down" 
 ...
 @if(count($result['commonContent']['cart'])>0)
                              ...
                              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownCartButton">
                                  <ul class="shopping-cart-items">
                                    ...
                                    <li>
                                        <span class="item-summary">@lang('website.Total')&nbsp;:&nbsp;<span class="currencyField">{{Session::get('symbol_left')}} {{ $total_amount*session('currency_value') }}{{Session::get('symbol_right')}}</span>
                                        </span>
                                    </li>
                                    <li>

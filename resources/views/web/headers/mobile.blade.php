          ...
          <div class="col-2 pr-0">
              <div class="navigation-mobile-container">
                  ...
                  <nav id="navigation-mobile">
                    <a href="javascript:void(0)" class="navigation-mobile-toggler float-right">
                    ...
                    @if(auth()->guard('customer')->check())
                      ...
                      <?php }else{ ?>
                        <div class="nav-link">@lang('website.Welcome')!</div>
                         <a href="javascript:void(0)" class="main-manu btn btn-primary trigger--login"><i class="fa fa-lock" aria-hidden="true"></i>&nbsp;@lang('website.Login/Register')</a>
                       <?php } ?>
                  </nav>
              </div>
    ...
    <div class="header-navbar bg-menu-bar">
      <div class="container">
        <form class="form-inline" action="{{ URL::to('/shop')}}" method="get">
          <div class="search">
            <div class="select-control">
              <select class="form-control category-value" name="category">
                <?php productCategories2(); ?>
              </select>
            </div>
            <input class="website-product__search_mobile" type="search" name="search" placeholder="@lang('website.Search entire store here')..."  value="{{ app('request')->input('search') }}">
